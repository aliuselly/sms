    ...
    <div id="loginform" class="loginBox">
        <form id="form" class="form form-horizontal" method="post" action="#">
            ...
            <div class="row cl">
                <label class="form-label col-3"><i class="Hui-iconfont">&#xe647;</i></label>
                <div class="formControls col-8">
                    <input id="verifiCode" class="input-text radius size-L" name="verifyCode" type="text"
                           placeholder="验证码"
                           style="width: 200px;">
            ...
            <div class="mt-20 skin-minimal" style="text-align: center;">
                <div class="radio-box">
                    ...
                    <label for="radio-3" style="color: #ffffff">管理员</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="radio-3" name="userType" value="3"/>
                    <label for="radio-2" style="color: #ffffff">老师</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="radio-2" name="userType" checked value="2"/>
                    <label for="radio-1" style="color: #ffffff">学生</label>
                </div>
            </div>
            <!-- 登录按钮 -->
            <div class="row">
...
<!-- 页面底部版权声明 -->
<div class="footer">
    Copyright @ 2020 aliuselly. All rights reserved | 本项目地址 : https://github.com/aliuselly/sms
</div>
</body>
</html>